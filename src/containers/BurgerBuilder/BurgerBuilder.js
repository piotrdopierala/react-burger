...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        onAddIngredient: () => dispatch({ type: actions.ADD_INGREDIENT_AMOUNT, ingredient: '', amount: 0 }),
        onRemoveIngredient: () => dispatch({ type: actions.SUB_INGREDIENT_AMOUNT, ingredient: '', amount: 0 })
    };
}
